...
frame_three=tk.Frame(bg_lbl,bg="sky blue",bd=5)
frame_three.place(x=80,y=60,width=450,height=50)


com_box=ttk.Combobox(frame_three,font=('times new roman',25,"bold"),width=10,values=["Imperial","Metric","Standard"])
com_box.grid(row=0,column=1,sticky="w")


btn2=tk.Button(frame_three,text="Select the unit system",fg="green",font=('times new roman',16,"bold"))
