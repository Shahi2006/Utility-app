...
txt_box=tk.Entry(frame_one,bg="light blue",font=('aldhabi',25,"bold"),width=17)
...
com_box=ttk.Combobox(frame_three,font=('times new roman',15,"bold"),width=50,values=["Imperial","Metric","Standard"])
