...
def weather():
    ...
    result=tk.Label(frame_two,font=("baguet script",20),fg="red",bg="gray",justify="left",anchor="nw")
    result.place(relwidth=1,relheight=1)
...
img=Image.open('images.webp')
img_photo=ImageTk.PhotoImage(img)
bg_lbl=tk.Label(root,image=img_photo)
bg_lbl.place(x=0,y=0,width=600,height=500)
menu_frame = tk.Frame(bg_lbl)
menu_frame.place(x=90,y=150)#expand = True,fill = "both", rely = 0.5, relx = 0.5)
