...
frame_three=tk.Frame(bg_lbl,bg="yellow",bd=5)
frame_three.place(x=80,y=60,width=450,height=50)


txt_box2=tk.Entry(frame_three,bg="light blue",font=('times new roman',25,"bold"),width=10)
txt_box2.grid(row=0,column=0,sticky="w")


btn2=tk.Button(frame_three,text="metric/imperial/standard",fg="green",font=('times new roman',16,"bold"))
